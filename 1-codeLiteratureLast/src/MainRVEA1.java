    ...
    public static void main(String[] args) throws IOException, MWException {
        ...
        for (int z = 0; z < 10; z++) {
            ...
            for (int i = 0; i < 1; i++){
                ...
                //开始前将存放输出的文件夹清空
//                String deletePath = "F:\\RVEAiGNGOutput\\2\\" + (i+1);
                String deletePath = "F:\\RVEAiGNGOutput\\2";
                Problem.deleteDir(deletePath);

                //开始前将存放所有解的文件夹清空
                String deleteAllPath = "F:\\pfResult\\RVEA\\TCA\\run"+ (z+1) + "\\"+ + i +"\\all";
                ...
                //先是存储初代种群数据
//                String xlsFile = "F:\\RVEAiGNGOutput\\2\\"+ (i+1) +"\\parent.xls";
                String xlsFile = "F:\\RVEAiGNGOutput\\2\\parent.xls";
...
//                String flagFilePath = "F:\\RVEAiGNGOutput\\2\\"+ (i+1) +"\\Flag.txt";
                String flagFilePath = "F:\\RVEAiGNGOutput\\2\\Flag.txt";
...
//                    File file = new File("F:\\RVEAiGNGOutput\\2\\"+ (i+1) +"\\parent" + j +".xls");
                    File file = new File("F:\\RVEAiGNGOutput\\2\\parent" + j +".xls");

                   //这一步确定父代
                    while (true){
//                    if (file.exists()){
                        //if (matlabFlagFile.exists()){
                        if (!flagFile.exists()){
                            indexList.clear();
...
//                    String xlsFile1 = "F:\\RVEAiGNGOutput\\2\\"+ (i+1) +"\\offspring"+ j +".xls";
                    String xlsFile1 = "F:\\RVEAiGNGOutput\\2\\offspring"+ j +".xls";
                ...
                //保存本次实验的所有的解
                String pathAll = "F:\\pfResult\\RVEA\\TCA\\run"+ (z+1) +"\\"+ i +"\\all\\"+"all"+i+".txt";
...
//                    String xlsFile1 = "F:\\RVEAiGNGOutput\\2\\"+ (i+1) +"\\offspring"+ j +".xls";
            ...
            //开始前将存放帕累托解的文件夹清空
            String deleteParetoPath = "F:\\pfResult\\RVEA\\TCA\\run"+ (z+1) +"\\pf";
            Problem.deleteDir(deleteParetoPath);

            //把八个环境下的pf保存下来
            for (int i = 0; i < 8; i++) {

                String path = "F:\\pfResult\\RVEA\\TCA\\run"+ (z+1) +"\\pf\\OriPF"+i+".txt";

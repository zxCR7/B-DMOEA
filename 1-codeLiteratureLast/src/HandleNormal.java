...
//
//                String path = "F:\\last\\pfResult\\1,3\\AnotherRefPF\\t"+ i +".txt";
//
        ...
        try {
            ...
            for (int i = 0; i < 2; i++) {
                switch (i){
                    case 0:
                        for (int j = 0; j < 1; j++) {
                            String path = "F:\\AllModel\\1,3\\IBEA\\TCA\\run"+ (j+1) +"\\normalPf\\OriPF0.txt";
                            FileReader fr = new FileReader(path);
                            BufferedReader bf = new BufferedReader(fr);
                            String str;
                            // 按行读取字符串
...
//                                arrayListT0.add(Double.parseDouble(split1[2]));
                    ...
                    case 1:
                        for (int j = 0; j < 1; j++) {
                            String path = "F:\\AllModel\\1,3\\IBEA\\BDA\\run"+ (j+1) +"\\normalPf\\OriPF0.txt";
                            FileReader fr = new FileReader(path);
                            BufferedReader bf = new BufferedReader(fr);
                            String str;
                            // 按行读取字符串
            ...
            String deletePath = "F:\\AllModel\\NonDominated\\IBEA";
            Problem.deleteDir(deletePath);

            for (int i = 0; i < 1; i++) {
                String path = "F:\\AllModel\\NonDominated\\IBEA\\t"+ i +".txt";
        ...
        try {
            ...
            for (int i = 0; i < 6; i++) {
                switch (i){
                    case 0:
                        for (int j = 0; j < 10; j++) {
                            String path = "F:\\last\\pfResult\\1,3\\NSGAII\\TCA\\run"+ (j+1) +"\\normalPf\\OriPF0.txt";
                            FileReader fr = new FileReader(path);
                            BufferedReader bf = new BufferedReader(fr);
                            String str;
                            // 按行读取字符串
...
//                                arrayListT0.add(Double.parseDouble(split1[2]));
                    ...
                    case 1:
                        for (int j = 0; j < 10; j++) {
                            String path = "F:\\last\\pfResult\\1,3\\NSGAII\\BDA\\run"+ (j+1) +"\\normalPf\\OriPF0.txt";
                            FileReader fr = new FileReader(path);
                            BufferedReader bf = new BufferedReader(fr);
                            String str;
                            // 按行读取字符串
...
//                                arrayListT0.add(Double.parseDouble(split1[2]));
                    ...
                    case 2:
                        for (int j = 0; j < 10; j++) {
                            String path = "F:\\last\\pfResult\\1,3\\RVEA\\TCA\\run"+ (j+1) +"\\normalPf\\OriPF0.txt";
                            FileReader fr = new FileReader(path);
                            BufferedReader bf = new BufferedReader(fr);
                            String str;
                            // 按行读取字符串
...
//                                arrayListT0.add(Double.parseDouble(split1[2]));
                    ...
                    case 3:
                        for (int j = 0; j < 10; j++) {
                            String path = "F:\\last\\pfResult\\1,3\\RVEA\\BDA\\run"+ (j+1) +"\\normalPf\\OriPF0.txt";
                            FileReader fr = new FileReader(path);
                            BufferedReader bf = new BufferedReader(fr);
                            String str;
                            // 按行读取字符串
...
//                                arrayListT0.add(Double.parseDouble(split1[2]));
                    ...
                    case 4:
                        for (int j = 0; j < 10; j++) {
                            String path = "F:\\last\\pfResult\\1,3\\IBEA\\TCA\\run"+ (j+1) +"\\normalPf\\OriPF0.txt";
                            FileReader fr = new FileReader(path);
                            BufferedReader bf = new BufferedReader(fr);
                            String str;
                            // 按行读取字符串
...
//                                arrayListT0.add(Double.parseDouble(split1[2]));
                    ...
                    case 5:
                        for (int j = 0; j < 10; j++) {
                            String path = "F:\\last\\pfResult\\1,3\\IBEA\\BDA\\run"+ (j+1) +"\\normalPf\\OriPF0.txt";
                            FileReader fr = new FileReader(path);
                            BufferedReader bf = new BufferedReader(fr);
                            String str;
                            // 按行读取字符串
...
//                                arrayListT7.add(Double.parseDouble(split1[2]));
            ...
            String deletePath = "F:\\last\\pfResult\\1,3\\AnotherRefPF";
            Problem.deleteDir(deletePath);
    ...
    public static void normalPF(){
        ...
        try{
            ...
            for (int z = 0; z < 10; z++){
                ...
                String deleteNormalPf = "F:\\last\\pfResult\\1,3\\NSGAII\\TCA\\run"+ (z+1) +"\\normalPf";
                ...
                for (int i = 0; i < 8; i++) {
                    ...
                    String path = "F:\\last\\pfResult\\1,3\\NSGAII\\TCA\\run"+ (z+1) +"\\pf\\OriPF"+ i +".txt";
                    FileReader fr = new FileReader(path);
                    BufferedReader bf = new BufferedReader(fr);
                    String str;
                    // 按行读取字符串
                    ...
                    //将归一化的pf保存起来
                    String pathNormal = "F:\\last\\pfResult\\1,3\\NSGAII\\TCA\\run"+ (z+1) +"\\normalPf\\OriPF"+ i +".txt";
            ...
            for (int z = 0; z < 10; z++){
                ...
                String deleteNormalPf = "F:\\last\\pfResult\\1,3\\NSGAII\\BDA\\run"+ (z+1) +"\\normalPf";
                File normalFile = new File(deleteNormalPf);
                if (!normalFile.exists()){
                    normalFile.mkdir();
                }
                ...
                for (int i = 0; i < 8; i++) {
                    ...
                    String path = "F:\\last\\pfResult\\1,3\\NSGAII\\BDA\\run"+ (z+1) +"\\pf\\OriPF"+ i +".txt";
                    FileReader fr = new FileReader(path);
                    BufferedReader bf = new BufferedReader(fr);
                    String str;
                    // 按行读取字符串
                    ...
                    //将归一化的pf保存起来
                    String pathNormal = "F:\\last\\pfResult\\1,3\\NSGAII\\BDA\\run"+ (z+1) +"\\normalPf\\OriPF"+ i +".txt";
            ...
            for (int z = 0; z < 10; z++){
                ...
                String deleteNormalPf = "F:\\last\\pfResult\\1,3\\RVEA\\TCA\\run"+ (z+1) +"\\normalPf";
                File normalFile = new File(deleteNormalPf);
                if (!normalFile.exists()){
                    normalFile.mkdir();
                }
                ...
                for (int i = 0; i < 8; i++) {
                    ...
                    String path = "F:\\last\\pfResult\\1,3\\RVEA\\TCA\\run"+ (z+1) +"\\pf\\OriPF"+ i +".txt";
                    FileReader fr = new FileReader(path);
                    BufferedReader bf = new BufferedReader(fr);
                    String str;
                    // 按行读取字符串
                    ...
                    //将归一化的pf保存起来
                    String pathNormal = "F:\\last\\pfResult\\1,3\\RVEA\\TCA\\run"+ (z+1) +"\\normalPf\\OriPF"+ i +".txt";
            ...
            for (int z = 0; z < 10; z++){
                ...
                String deleteNormalPf = "F:\\last\\pfResult\\1,3\\RVEA\\BDA\\run"+ (z+1) +"\\normalPf";
                File normalFile = new File(deleteNormalPf);
                if (!normalFile.exists()){
                    normalFile.mkdir();
                }
                ...
                for (int i = 0; i < 8; i++) {
                    ...
                    String path = "F:\\last\\pfResult\\1,3\\RVEA\\BDA\\run"+ (z+1) +"\\pf\\OriPF"+ i +".txt";
                    FileReader fr = new FileReader(path);
                    BufferedReader bf = new BufferedReader(fr);
                    String str;
                    // 按行读取字符串
                    ...
                    //将归一化的pf保存起来
                    String pathNormal = "F:\\last\\pfResult\\1,3\\RVEA\\BDA\\run"+ (z+1) +"\\normalPf\\OriPF"+ i +".txt";
            ...
            for (int z = 0; z < 10; z++){
                ...
                String deleteNormalPf = "F:\\last\\pfResult\\1,3\\IBEA\\TCA\\run"+ (z+1) +"\\normalPf";
                File normalFile = new File(deleteNormalPf);
                if (!normalFile.exists()){
                    normalFile.mkdir();
                }
                ...
                for (int i = 0; i < 8; i++) {
                    ...
                    String path = "F:\\last\\pfResult\\1,3\\IBEA\\TCA\\run"+ (z+1) +"\\pf\\OriPF"+ i +".txt";
                    FileReader fr = new FileReader(path);
                    BufferedReader bf = new BufferedReader(fr);
                    String str;
                    // 按行读取字符串
                    ...
                    //将归一化的pf保存起来
                    String pathNormal = "F:\\last\\pfResult\\1,3\\IBEA\\TCA\\run"+ (z+1) +"\\normalPf\\OriPF"+ i +".txt";
            ...
            for (int z = 0; z < 10; z++){
                ...
                String deleteNormalPf = "F:\\last\\pfResult\\1,3\\IBEA\\BDA\\run"+ (z+1) +"\\normalPf";
                File normalFile = new File(deleteNormalPf);
                if (!normalFile.exists()){
                    normalFile.mkdir();
                }
                ...
                for (int i = 0; i < 8; i++) {
                    ...
                    String path = "F:\\last\\pfResult\\1,3\\IBEA\\BDA\\run"+ (z+1) +"\\pf\\OriPF"+ i +".txt";
                    FileReader fr = new FileReader(path);
                    BufferedReader bf = new BufferedReader(fr);
                    String str;
                    // 按行读取字符串
                    ...
                    //将归一化的pf保存起来
                    String pathNormal = "F:\\last\\pfResult\\1,3\\IBEA\\BDA\\run"+ (z+1) +"\\normalPf\\OriPF"+ i +".txt";
        ...
        try{
            for (int i = 0; i < 10; i++) {
                for (int j = 0; j < 8; j++) {
                    ...
                    String path = "F:\\last\\pfResult\\1,3\\NSGAII\\TCA\\run"+ (i+1) +"\\normalPf\\OriPF"+ j +".txt";
                    FileReader fr = new FileReader(path);
                    BufferedReader bf = new BufferedReader(fr);
                    String str;
                    // 按行读取字符串
            ...
            for (int i = 0; i < 10; i++) {
                for (int j = 0; j < 8; j++) {
                    ...
                    String path = "F:\\last\\pfResult\\1,3\\RVEA\\BDA\\run"+ (i+1) +"\\normalPf\\OriPF"+ j +".txt";
                    FileReader fr = new FileReader(path);
                    BufferedReader bf = new BufferedReader(fr);
                    String str;
                    // 按行读取字符串
            ...
            for (int i = 0; i < 10; i++) {
                for (int j = 0; j < 8; j++) {
                    ...
                    String path = "F:\\last\\pfResult\\1,3\\IBEA\\TCA\\run"+ (i+1) +"\\normalPf\\OriPF"+ j +".txt";
                    FileReader fr = new FileReader(path);
                    BufferedReader bf = new BufferedReader(fr);
                    String str;
                    // 按行读取字符串
...
//
            ...
            mean_IGD_IT_PBEA = mean_IGD_IT_PBEA/10;

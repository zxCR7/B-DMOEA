...
/**
 * The <code>DisToPf</code> class provides a Java interface to MATLAB functions. 
 * The interface is compiled from the following files:
 * <pre>
 *  F:\\科研\\MOEA\\B\\BDAmmd.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>DisToPf</code> instance 
 * when it is no longer needed to ensure that native resources allocated by this class 
 * are properly freed.
 * @version 0.0
 */
public class DisToPf extends MWComponentInstance<DisToPf>
{
    /**
     ...
     */
    private DisToPf (final MWMCR mcr) throws MWException
    {
        super(mcr);
        // add this to sInstances
        synchronized(DisToPf.class) {
            sInstances.add(this);
        }
    }

    /**
     * Constructs a new instance of the <code>DisToPf</code> class.
     * @throws MWException An error has occurred during the function call.
     */
    public DisToPf() throws MWException
    {
    ...
    /**
     * @deprecated Please use the constructor {@link #DisToPf(MWComponentOptions componentOptions)}.
     * The <code>com.mathworks.toolbox.javabuilder.MWComponentOptions</code> class provides an API to set the
     * path to the component.
     * @param pathToComponent Path to component directory.
     * @throws MWException An error has occurred during the function call.
     */
    public DisToPf(String pathToComponent) throws MWException
    {
        this(BDAmmdMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    
    /**
     * Constructs a new instance of the <code>DisToPf</code> class. Use this constructor 
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public DisToPf(MWComponentOptions componentOptions) throws MWException
    {

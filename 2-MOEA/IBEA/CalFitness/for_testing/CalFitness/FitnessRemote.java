...
/**
 * The <code>FitnessRemote</code> class provides a Java RMI-compliant interface to MATLAB 
 * functions. The interface is compiled from the following files:
 * <pre>
 *  F:\\科研\\MOEA\\IBEA\\CalFitness.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>FitnessRemote</code> 
 ...
 * generate RMI server proxy objects for instances of CalFitness.Fitness.
 */
public interface FitnessRemote extends Poolable
{
    /**

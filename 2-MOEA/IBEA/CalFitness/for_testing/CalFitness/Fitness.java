...
/**
 * The <code>Fitness</code> class provides a Java interface to MATLAB functions. 
 * The interface is compiled from the following files:
 * <pre>
 *  F:\\科研\\MOEA\\IBEA\\CalFitness.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>Fitness</code> instance 
 * when it is no longer needed to ensure that native resources allocated by this class 
 * are properly freed.
 * @version 0.0
 */
public class Fitness extends MWComponentInstance<Fitness>
{
    /**
     ...
     */
    private Fitness (final MWMCR mcr) throws MWException
    {
        super(mcr);
        // add this to sInstances
        synchronized(Fitness.class) {
            sInstances.add(this);
        }
    }

    /**
     * Constructs a new instance of the <code>Fitness</code> class.
     * @throws MWException An error has occurred during the function call.
     */
    public Fitness() throws MWException
    {
    ...
    /**
     * @deprecated Please use the constructor {@link #Fitness(MWComponentOptions componentOptions)}.
     * The <code>com.mathworks.toolbox.javabuilder.MWComponentOptions</code> class provides an API to set the
     * path to the component.
     * @param pathToComponent Path to component directory.
     * @throws MWException An error has occurred during the function call.
     */
    public Fitness(String pathToComponent) throws MWException
    {
        this(CalFitnessMCRFactory.newInstance(getPathToComponentOptions(pathToComponent)));
    }
    
    /**
     * Constructs a new instance of the <code>Fitness</code> class. Use this constructor 
     ...
     * @throws MWException An error has occurred during the function call.
     */
    public Fitness(MWComponentOptions componentOptions) throws MWException
    {

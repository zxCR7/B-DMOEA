...
/**
 * The <code>IEBAfitnessRemote</code> class provides a Java RMI-compliant interface to 
 * MATLAB functions. The interface is compiled from the following files:
 * <pre>
 *  F:\\科研\\MOEA\\IBEA\\CalFitness.m
 * </pre>
 * The {@link #dispose} method <b>must</b> be called on a <code>IEBAfitnessRemote</code> 
 ...
 * generate RMI server proxy objects for instances of CalFitness.IEBAfitness.
 */
public interface IEBAfitnessRemote extends Poolable
{
    /**
     * Provides the standard interface for calling the <code>CalFitness</code> MATLAB 
     ...
     */
    public Object[] CalFitness(int nargout, Object... rhs) throws RemoteException;
